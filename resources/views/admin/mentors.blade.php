                ...
                <table class="table">
                    ...
                    @foreach($mentors as $mentor)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('user.details',$mentor->id)}}"> <button class="btn btn-success" > View </button> </a>
                                @if($mentor->active)
                                    <a href="{{route('user.disable',$mentor->id)}}"> <button class="btn btn-danger" >Disable</button> </a>
                                @endif
                                @if(!$mentor->active)
                                    <a href="{{route('user.disable',$mentor->id)}}"> <button class="btn btn-info">Enable </button> </a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
