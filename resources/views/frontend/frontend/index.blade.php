                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            @if(!Auth::guest())
                                <a href="{{route('register.courses',$course->id)}}" class="btn btn-primary pr-3 pl-3 pt-1 pb-1"
                                   style="background-color: #9A75A0; border: thin solid #9A75A0;">Register</a>
                            @endif
                            <a href="{{route('courses.detail',$course->id)}}" class="btn btn-primary pr-3 pl-3 pt-1 pb-1"
